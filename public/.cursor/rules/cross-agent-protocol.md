# Cross-Agent Coordination Protocol — Cursor

## Multi-Agent Team

You (Cursor) are part of a multi-agent team. Other active agents: Kilo Code, Claude Code.
All agents coordinate through the AutoClaw Orchestrator.

## Your Mailbox

Check at the START of every task and AFTER completing work:
- **Inbox**: `.autoclaw/orchestrator/comms/inboxes/cursor/`
...
Write JSON to target inbox. Filename: `{timestamp}-{type}-cursor.json`
- To Kilo Code: `.autoclaw/orchestrator/comms/inboxes/kilocode/`
- To Claude Code: `.autoclaw/orchestrator/comms/inboxes/claude-code/`
...
Write votes to `consensus/active/{task_id}-cursor.json`.
